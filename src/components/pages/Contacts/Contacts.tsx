...
import balakalo from "../../assets/images/contacts/balakalo.jpg"
    ...
    const items = [
        <div className={"card mx-auto w-100 my-auto"}>
            <div className="contact-photo">
                <img src={balakalo} className={""} alt="ЦРМ_main_director" />
            </div>
            <div>
                <p className={"text-scale-large"}>Балакало Максим</p>
        ...
        <div className={"card col-4 px-4 py-3 mx-auto w-100 my-auto"}>
            <div className="row row-cols-1 links information-card  text-start h-100 text-start">
                <div className="col d-flex flex-wrap ">
                    <span className="text-weight-normal text-scale-normal">Телефон: <a className="text-weight-normal text-scale-normal more-arrow" href="tel:+79065689673">8(906)568-96-73</a></span>
                    <span className="text-weight-normal text-scale-normal">Email: <a className="text-weight-normal text-scale-normal more-arrow" href="mailto:maks.balakalo@bmstu.ru">maks.balakalo@bmstu.ru</a></span>
                </div>
                ...
                <div className="desktop h-100  w-100">
                    <div className="container-fluid d-flex flex-row wrapper justify-content-center h-100 align-items-center my-0">
                        <div className="card col-4 orange-overlay">
                            <img src={balakalo} className={"contact-photo"} alt="ЦРМ_director_photo" />
                            <div className={"card-img-overlay d-flex flex-column justify-content-end align-items-center"}>
                                <p className={"text-weight-normal text-scale-large"}>Балакало Максим</p>
                                <p className={"text-weight-bold text-scale-normal"}>Руководитель ЦМР</p>
                                <p className={"text-weight-normal text-scale-normal"}>+7 (906) 568-96-73</p>
                                <p className={"text-weight-normal text-scale-normal"}>maks.balakalo@bmstu.ru</p>
                            </div>
                        </div>
                        <div className={"card col-4 "}>
                            <div className="row row-cols-1 links information-card  text-start h-100">
                                ...
                                <div className="col">
                                    <span className={"text-weight-normal text-scale-normal d-flex gap-1 "}>Адрес: <a href="https://yandex.ru/maps/-/CDcPvD9e" className={"d-flex flex-nowrap more-arrow"}>Схема проезда</a> </span>
                                    <p className="text-weight-normal text-scale-normal">105005, г. Москва, Бауманская ул., 57Б, стр. 1</p>
                                </div>
                                <div className="col">
